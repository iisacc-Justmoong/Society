    ...
    Controls.ScrollView {
        ...
        RowLayout {
            ...
            LV.Label {
                ...
                Layout.fillWidth: true
                text: panel.network.mode === NetworkDriveController.HostMode ? qsTr("Desktop host") : qsTr("Mobile client")
            }
            LV.PushButton {
        ...
        ColumnLayout {
            ...
            LV.PushButton {
                ...
                onClicked: panel.network.configureServer(serverAddress.text.trim())
            }
            LV.LabelButton {
                ...
                onClicked: panel.network.configureServer("")
            }
        }
        LV.PushButton {
